...
class TestFourPeaksGenerator:
    ...
    def test_generate_size_zero(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            FourPeaksGenerator.generate(seed=SEED, size=0)
    ...
    def test_generate_negative_size(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            FourPeaksGenerator.generate(seed=SEED, size=-5)
    ...
    def test_generate_non_integer_size(self):
        ...
        with pytest.raises(TypeError):
            FourPeaksGenerator.generate(seed=SEED, size="ten")

    def test_generate_negative_t_pct(self):
        """Test generate method raises ValueError when t_pct is less than 0."""
        with pytest.raises(ValueError) as excinfo:
            FourPeaksGenerator.generate(seed=SEED, size=10, t_pct=-0.1)
    ...
    def test_generate_t_pct_greater_than_one(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            FourPeaksGenerator.generate(seed=SEED, size=10, t_pct=1.1)
    ...
    def test_generate_non_float_t_pct(self):
        ...
        with pytest.raises(TypeError):
            FourPeaksGenerator.generate(seed=SEED, size=10, t_pct="high")

    def test_generate_default_size(self):
        """Test generate method with default size."""
        problem = FourPeaksGenerator.generate(seed=SEED)
    ...
    def test_generate_default_t_pct(self):
        ...
        size = 20
        problem = FourPeaksGenerator.generate(seed=SEED, size=size)
    ...
    def test_generate_custom_size_and_threshold(self):
        ...
        size = 30
        t_pct = 0.2
        problem = FourPeaksGenerator.generate(seed=SEED, size=size, t_pct=t_pct)
