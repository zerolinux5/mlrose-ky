...
setup(
    ...
    packages=[
        "mlrose_hiive",
        "mlrose_hiive.runners",
        "mlrose_hiive.generators",
        "mlrose_hiive.algorithms",
        "mlrose_hiive.algorithms.decay",
        "mlrose_hiive.algorithms.crossovers",
        "mlrose_hiive.opt_probs",
        "mlrose_hiive.fitness",
        "mlrose_hiive.algorithms.mutators",
        "mlrose_hiive.neural",
        "mlrose_hiive.neural.activation",
        "mlrose_hiive.neural.fitness",
        "mlrose_hiive.neural.utils",
        "mlrose_hiive.decorators",
        "mlrose_hiive.gridsearch",
        "mlrose_hiive.samples",
    ],
